import { Bug, MessagesSquare, Computer } from "lucide-react";
  ...
  return (
    <div id="contact" className="isolate px-6 py-24 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-2xl sm:text-center">
        ...
        <p className="mt-2 text-lg leading-8 text-foreground/50">
      ...
      <div className="mx-auto mt-20 max-w-lg space-y-16">
        <div className="flex gap-x-6">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary">
            <MessagesSquare className="h-6 w-6 text-white" aria-hidden="true" />
          </div>
          <div>
            <h3 className="text-base font-semibold leading-7">Sales support</h3>
            <p className="mt-2 leading-7 text-foreground/50">
        ...
        <div className="flex gap-x-6">
          ...
          <div>
            <h3 className="text-base font-semibold leading-7">Bug reports</h3>
            <p className="mt-2 leading-7 text-foreground/50">
        ...
        <div className="flex gap-x-6">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary">
            <Computer className="h-6 w-6 text-white" aria-hidden="true" />
          </div>
          <div>
