        ...
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <div className="mt-10 flex items-center gap-x-4">
              ...
              <div className="h-px flex-auto bg-foreground" />
            </div>
            <ul
              role="list"
            ...
            <div className="rounded-2xl py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div className="mx-auto max-w-xs px-8">
                ...
                <p className="mt-6 flex items-baseline justify-center gap-x-2">
                  ...
                  <span className="text-sm font-semibold leading-6 tracking-wide text-foreground/50">
                    USD
                  </span>
                </p>
                <Button className="mt-5">Get access</Button>
